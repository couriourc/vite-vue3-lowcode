...
export const initVisualData = (id: string) => {
...
export const fieldTypes: {
  label: string;
  value: FieldTypesValue;
}[] = [
  {
    label: '字符串',
    value: FieldTypesValue.String,
  },
  {
    label: '数字',
    value: FieldTypesValue.Number,
  },
  {
    label: '数组',
    value: FieldTypesValue.Array,
  },
  {
    label: '布尔值',
    value: FieldTypesValue.Boolean,
  },
  {
    label: '路径参数（query）',
    value: FieldTypesValue.Query,
  },
  {
    label: '缓存（session）',
    value: FieldTypesValue.SessionStorage,
  },
  {
    label: '缓存（local）',
    value: FieldTypesValue.LocalStorage,
  },
];
